...
function ViewAttempts() {
    ...
    useEffect(() => {
        if (user && user.username) {
            fetch(`https://server-rgjzels57-hilmar-chesters-projects.vercel.app/api/attempts/view-attempts/${user.username}`) // Adjust this URL to your API endpoint for fetching attempts
